...
urlpatterns = [
    ...
    url(r'^beaches/south-maui/maluaka-beach/$', views.MaluakaView.as_view(), name='maluaka'),
    url(r'^beaches/south-maui/big-beach/$', views.BigBeachView.as_view(), name='big_beach'),
